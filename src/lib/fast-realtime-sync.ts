// src/lib/fast-realtime-sync.ts
// Versión optimizada para operaciones rápidas sin optimización de archivos
...
/**
 * Agrega un item con sincronización rápida (sin optimización de archivos)
 */
export const addItemWithFastRealtimeSync = async <T extends Record<string, any>>(
  tableName: string,
  ...
  // Subir archivo directamente (sin optimización para mayor velocidad)
...
/**
 * Actualiza un item con sincronización rápida
 */
export const updateItemWithFastRealtimeSync = async <T extends Record<string, any>>(
  tableName: string,
  id: string,
  itemData: Omit<T, 'id' | 'url' | 'type' | 'file'>,
  newMediaFile?: File,
