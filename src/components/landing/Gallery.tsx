              ...
              <div className="relative aspect-square w-full">
                {item.type === 'image' ? (
                  ...
                  <>
                    ...
                    />
                    <div 
                      className="absolute inset-0 bg-black/20 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none group-data-[playing=true]:opacity-0"
                    >
