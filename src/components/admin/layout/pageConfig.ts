...
import { Brush, FileText, Home, ImageIcon, MessageSquare, Palette, ShoppingBag, Sparkles, Star, Users, SprayCan } from 'lucide-react';
...
export const pageConfig = [
  ...
  { id: 'ai-content', title: 'Ideas con IA', icon: MessageSquare },
];
