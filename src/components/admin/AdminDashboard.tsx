...
export function AdminDashboard({
  ...
  const getInputClasses = () => {
    return 'bg-background border-border text-foreground placeholder-muted-foreground focus:border-primary h-12 sm:h-11 text-base';
  };
  ...
  const getButtonClasses = () => {
    return {
      ...
      danger: 'text-destructive hover:text-destructive/80 hover:bg-destructive/10'
    };
  };
  ...
  const getTableClasses = () => {
    return {
      ...
      row: 'border-border hover:bg-accent',
  ...
  const renderContent = () => {
    switch (section) {
      case 'hero':
        return (
          <motion.div 
            className={`min-h-screen ${theme === 'dark' ? 'bg-gray-900' : 'bg-blue-50'} py-8`}
            initial={{ opacity: 0 }}
                  ...
                  <form onSubmit={handleHeroUpdate} className="space-y-8">
                    ...
                    {/* Image Section */}
                        ...
                        <Label className={`text-sm font-medium ${getTextClasses().label}`}>Imagen Actual</Label>
                            <motion.div 
                              className={`relative w-full max-w-md h-48 rounded-lg overflow-hidden border ${theme === 'dark' ? 'border-gray-600 bg-gray-700' : 'border-gray-200 bg-gray-50'}`}
                              whileHover={{ scale: 1.02 }}
                              transition={{ duration: 0.2 }}
                            >
                        <Media
          ...
          >
            ...
            >
              <Card className="bg-card border">
                ...
                >
                  <CardHeader>
                    <CardTitle className="font-headline text-foreground">Gestionar 'Sobre Mí'</CardTitle>
                  </CardHeader>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
              ...
              <CardContent>
                <form onSubmit={handleAboutMeUpdate} className="space-y-4">
                      ...
                      >
                        <Textarea 
                          name="text" 
                          defaultValue={aboutMeContent.text} 
                          rows={6} 
                      ...
                      >
                        ...
                        >
                          <Input 
                            name="happyClients" 
                            defaultValue={aboutMeContent.happyClients} 
                            className="bg-background border-border text-foreground placeholder-muted-foreground focus:border-primary" 
                          />
                        </motion.div>
                        <motion.div
                        ...
                        >
                          <Input 
                            ...
                            defaultValue={aboutMeContent.yearsOfExperience} 
                            className="bg-background border-border text-foreground placeholder-muted-foreground focus:border-primary" 
                          />
                        </motion.div>
                        <motion.div
                        ...
                        >
                          <Input 
                            name="events" 
                            defaultValue={aboutMeContent.events} 
                            className="bg-background border-border text-foreground placeholder-muted-foreground focus:border-primary" 
                          />
                        </motion.div>
                      </motion.div>
                      ...
                      >
                        <DragDropUpload 
                          name="mediaFile" 
                          accept="image/*,video/*" 
                          onFileSelect={(file) => handleMediaFilePreview(file, setAboutMePreview)} 
                        />
                      </motion.div>
                      <motion.div
                        initial={{ opacity: 0, scale: 0.9 }}
                      ...
                      >
                        <MediaPreview 
                          ...
                          onRemove={() => setAboutMePreview(null)} 
                        />
                      </motion.div>
                      <motion.div
                        initial={{ opacity: 0, y: 20 }}
                      ...
                      >
                        ...
                        >
                          <Button 
                            type="submit" 
                            className="flex items-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground h-12 w-full sm:w-auto sm:px-8"
                          >
                    Actualizar 'Sobre Mí'
                  </Button>
                        </motion.div>
              ...
              {pendingTestimonials.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {pendingTestimonials.map((testimonial) => (
                    <Card key={testimonial.id} className="shadow-md bg-card border">
                      <CardContent className="p-4 space-y-3">
                        <h3 className={`font-semibold ${getTextClasses().primary}`}>{testimonial.author}</h3>
                        <p className={`text-sm ${getTextClasses().secondary} italic`}>"{testimonial.text}"</p>
        ...
        return (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              ...
              <div className="bg-card rounded-lg p-6 shadow-lg border">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-muted-foreground mb-1">Total de Productos</p>
                    <p className="text-3xl font-bold text-foreground">{appState.products.length}</p>
                    <p className="text-sm text-green-500 mt-1">
                      {appState.products.filter(p => p.stock && p.stock > 0).length} en stock
                    </p>
                  </div>
              ...
              <div className="bg-card rounded-lg p-6 shadow-lg border">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-muted-foreground mb-1">Total de Perfumes</p>
                    <p className="text-3xl font-bold text-foreground">{appState.perfumes.length}</p>
                    <p className="text-sm text-green-500 mt-1">
                      {appState.perfumes.filter(p => p.stock && p.stock > 0).length} en stock
                    </p>
                  </div>
                  <div className="w-12 h-12 bg-primary rounded-lg flex items-center justify-center">
                    <svg className="w-6 h-6 text-primary-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-card rounded-lg p-6 shadow-lg border">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-muted-foreground mb-1">Servicios Ofrecidos</p>
                    <p className="text-3xl font-bold text-foreground">{appState.services.length}</p>
                    <p className="text-sm text-green-500 mt-1">activos</p>
                  </div>
                  <div className="w-12 h-12 bg-primary rounded-lg flex items-center justify-center">
                    <svg className="w-6 h-6 text-primary-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-card rounded-lg p-6 shadow-lg border">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-muted-foreground mb-1">Testimonios</p>
                    <p className="text-3xl font-bold text-foreground">{appState.testimonials.length}</p>
                    <p className="text-sm text-muted-foreground mt-1">
                      {appState.testimonials.filter(t => t.status === 'approved').length} aprobados, {' '}
                      {appState.testimonials.filter(t => t.status === 'pending').length} pendientes
                    </p>
                  </div>
                  <div className="w-12 h-12 bg-primary rounded-lg flex items-center justify-center">
                    <svg className="w-6 h-6 text-primary-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-card rounded-lg p-6 shadow-lg border">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-muted-foreground mb-1">Galería</p>
                    <p className="text-3xl font-bold text-foreground">{appState.gallery.length}</p>
                    <p className="text-xs text-muted-foreground mt-1">imágenes y videos</p>
                  </div>
                  <div className="w-12 h-12 bg-primary rounded-lg flex items-center justify-center">
                    <svg className="w-6 h-6 text-primary-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {/* Ventas Mensuales */}
              <div className="bg-card rounded-lg p-6 shadow-lg border">
                <h3 className="text-xl font-semibold text-foreground mb-4">Ventas Mensuales</h3>
                <div className="h-80 flex items-center justify-center">
                  <div className="text-center">
                    <svg className="w-32 h-32 mx-auto mb-4 text-muted-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                    </svg>
                    <p className="text-lg text-muted-foreground">Gráfico de Ventas</p>
                    <p className="text-sm text-muted-foreground/70">Los datos se mostrarán aquí</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card rounded-lg p-6 shadow-lg border">
                <h3 className="text-xl font-semibold text-foreground mb-4">Distribución de Productos</h3>
